 ...
 */
Stack* Stack_Level_Code(Stack* stack, Stack* code, int* link, const int* seed, int nseed);
Stack* Stack_Level_Code_Constraint(Stack* stack, Stack* code, int* link, const int* seed, int nseed, int max_level);
