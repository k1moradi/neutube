...
public:
  ZDvidAnnotation();
  enum EKind { KIND_POST_SYN, KIND_PRE_SYN, KIND_NOTE, KIND_UNKNOWN, KIND_INVALID };
  static ZStackObject::EType GetType() { return ZStackObject::TYPE_DVID_ANNOTATION; }
...
public:
  static void AddProperty(ZJsonObject &json, const std::string &key, const std::string &value);
  static void AddProperty(ZJsonObject &json, const std::string &key, bool value);
private:
  void init();
