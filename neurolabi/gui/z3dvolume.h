...
public:
  ...
  glm::vec3 getParentVolWorldLUF() const {
    return !isSubVolume() ? getWorldLUF() : m_hasTransformMatrix ? glm::applyMatrix(m_transformationMatrix, getParentVolPhysicalLUF())
                                                                 : getParentVolPhysicalLUF();
  }
  glm::vec3 getParentVolWorldRDB() const {
    return !isSubVolume() ? getWorldRDB() : m_hasTransformMatrix ? glm::applyMatrix(m_transformationMatrix, getParentVolPhysicalRDB())
                                                                 : getParentVolPhysicalRDB();
  }
  glm::vec3 getParentVolWorldLDF() const {
    return !isSubVolume() ? getWorldLDF() : m_hasTransformMatrix ? glm::applyMatrix(m_transformationMatrix, getParentVolPhysicalLDF())
                                                                 : getParentVolPhysicalLDF();
  }
  glm::vec3 getParentVolWorldRDF() const {
    return !isSubVolume() ? getWorldRDF() : m_hasTransformMatrix ? glm::applyMatrix(m_transformationMatrix, getParentVolPhysicalRDF())
                                                                 : getParentVolPhysicalRDF();
  }
  glm::vec3 getParentVolWorldRUF() const {
    return !isSubVolume() ? getWorldRUF() : m_hasTransformMatrix ? glm::applyMatrix(m_transformationMatrix, getParentVolPhysicalRUF())
                                                                 : getParentVolPhysicalRUF();
  }
  glm::vec3 getParentVolWorldLUB() const {
    return !isSubVolume() ? getWorldLUB() : m_hasTransformMatrix ? glm::applyMatrix(m_transformationMatrix, getParentVolPhysicalLUB())
                                                                 : getParentVolPhysicalLUB();
  }
  glm::vec3 getParentVolWorldLDB() const {
    return !isSubVolume() ? getWorldLDB() : m_hasTransformMatrix ? glm::applyMatrix(m_transformationMatrix, getParentVolPhysicalLDB())
                                                                 : getParentVolPhysicalLDB();
  }
  glm::vec3 getParentVolWorldRUB() const {
    return !isSubVolume() ? getWorldRUB() : m_hasTransformMatrix ? glm::applyMatrix(m_transformationMatrix, getParentVolPhysicalRUB())
                                                                 : getParentVolPhysicalRUB();
  }
