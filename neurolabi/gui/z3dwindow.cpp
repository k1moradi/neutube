...
Z3DMainWindow::Z3DMainWindow(QWidget* parent)
  : QMainWindow(parent) {
  setParent(parent);
...
Z3DTabWidget::Z3DTabWidget(QWidget* parent)
  : QTabWidget(parent) {
...
Z3DWindow::Z3DWindow(ZSharedPointer<ZStackDoc> doc, Z3DWindow::EInitMode initMode, bool stereoView, QWidget* parent)
  : QMainWindow(parent)
  , m_initOk(false)
  , m_doc(doc)
