...
public:
  ...
  inline void setCurrentSource(const QWidget *source) { m_currentSource = const_cast<QWidget*>(source); }
  inline void setOriginalSource(const QWidget *source) { m_originalSource = const_cast<QWidget*>(source); }
