...
public:
  ...
  void updateLower(ZMovieSceneClipper::ETarget target, ZMovieSceneClipper::EClipAxis axis, double dv);
  void updateUpper(ZMovieSceneClipper::ETarget target, ZMovieSceneClipper::EClipAxis axis, double dv);
  int getLowerClip(ZMovieSceneClipper::ETarget target, ZMovieSceneClipper::EClipAxis axis);
  int getUpperClip(ZMovieSceneClipper::ETarget target, ZMovieSceneClipper::EClipAxis axis);
  void setLowerClip(ZMovieSceneClipper::ETarget target, ZMovieSceneClipper::EClipAxis axis, double v);
  void setUpperClip(ZMovieSceneClipper::ETarget target, ZMovieSceneClipper::EClipAxis axis, double v);
