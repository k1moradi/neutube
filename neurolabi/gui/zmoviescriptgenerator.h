...
public:
  ...
  void writeAction(std::ostream& stream, const std::vector<std::string>& actions, int indentLevel);
  void writeAction(std::ostream& stream, const std::string& id, const std::vector<std::string>& actions, int indentLevel);
  void writeAction(std::ostream& stream, const std::vector<std::string>& id, const std::vector<std::string>& actions, int indentLevel);
  ...
  void writeCameraReset(std::ostream& stream, const std::vector<std::string>& reset, int indentLevel);
  void writeCameraMove(std::ostream& stream, const std::vector<std::string>& camera, int indentLevel);
  void writeCameraRotate(std::ostream& stream, const std::vector<std::string>& camera, int indentLevel);
