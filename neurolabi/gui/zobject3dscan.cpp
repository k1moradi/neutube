...
bool ZObject3dScan::importDvidObjectBuffer(
  ...
  // reserved byte (currently unused)
  tz_uint8 reserved = 0;
  READ_BYTE_BUFFER(reserved, tz_uint8);
  // numberOfVoxels (currently unused, but must be consumed)
  tz_uint32 numberOfVoxels = 0;
  READ_BYTE_BUFFER(numberOfVoxels, tz_uint32);
  tz_uint32 numberOfSpans = 0;
