...
public:
  explicit ZStackFrame(QWidget *parent = nullptr, Qt::WindowFlags flags = {});
...
public:
  ...
  void saveTraceProject(const QString &filePath, const QString &output, const QString &prefix);
...
public:
  ...
  ZStackFrame *spinoffStackSelection(const std::vector<std::vector<double> > &selected);
  void invertStack();
  void yFlipStack();
...
public slots:
  void setLocsegChainInfo(ZLocsegChain *chain, QString prefix = "", QString suffix = "");
...
protected:
  ...
  void updateDocument();
  typedef bool FConnectAction(const QObject*, const char *, const QObject *, const char *);
  static bool connectFunc(const QObject* obj1, const char *signal, const QObject *obj2, const char *slot);
